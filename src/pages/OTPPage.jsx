  ...
  return (
    <div className="flex-1 flex flex-col bg-white min-h-0">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-6 min-w-0">
        ...
        {/* OTP boxes — 6 equally-flexible cells that always fit inside the
            phone frame, with a sensible max width. */}
        <div className="grid grid-cols-6 gap-2 mt-8 max-w-[360px]">
          {otp.map((d, i) => (
            <input
              key={i}
